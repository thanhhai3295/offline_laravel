...
class GroupattrModel extends AdminModel
{
    public function __construct() {
        $this->table = 'attr_group';
    ...
    public function getItem($params = null,$options = null){
        ...
        if($options['task'] == 'get-name'){
            $result = $this->select('name')->whereIn('id',$params['id'])->get();
            if($result) $result = $result->pluck('name')->toArray();
        }
        return $result;
    }
