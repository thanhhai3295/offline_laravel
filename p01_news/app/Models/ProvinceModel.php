...
class ProvinceModel extends AdminModel
{
    ...
    public function listItems($params = null,$options = null) {
        $result = null;
            if($options['task'] == 'admin-list-items') {
                $query = $this->select('id','fee','province','created','created_by','modified','modified_by','status');
    ...
    public function saveItems($params = null,$options = null){
        ...
        if($options['task'] == 'change-fee'){
            $this->where('id',$params['id'])->update(['fee' => $params['fee']]);
        }
