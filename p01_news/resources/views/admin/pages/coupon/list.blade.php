      ...
      <tbody>          
        ...
        @foreach ($items as $key => $value)
          @php
            ...
            $type            = Template::showItemSelect($controllerName,$id,$value['type'],'type_coupon');
            $priceValue      = Form::text('value',$value['value'],['class' => 'form-control','data-id' => $id,'data-url' => route($controllerName.'/value',['value' => 'value','id' => $id])]);
