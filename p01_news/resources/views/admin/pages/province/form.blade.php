...
@php
  ...
  $provinceValue = [
    'default'  => config('zvn.province.default.name'),
    'tphcm'   => config('zvn.province.tphcm.name'),
    'hn' => config('zvn.province.hn.name'),
    'dn' => config('zvn.province.dn.name')
  ];
  $statusValue = [
  ...
  $elements = [
    ...
    [
      ...
      'element' => Form::select('province', $provinceValue, $item['province'],$formInputAttr),
      'error' => 'province'
    ],
    [
