...
@php
  ...
  $elements = [
    ...
    [
      ...
      'element' => Form::textArea('content', $item['content'],$formCkeditorAttr),
      'error' => 'content'
    ],
    [
    ...
    [
      ...
      'thumb' => !empty($item['id']) ? Template::showItemThumb($controllerName,$item['thumb'],$item['name']) : '<img id="blah" class="zvn-thumb">',
      'type' => 'thumb',
      'error' => 'thumb'
    ],
    [
